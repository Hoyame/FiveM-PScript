...
RegisterNUICallback('updateSkin', function(data)
	...
	if(v == true) then
		...
		TriggerServerEvent('corazon_character:save', skin_data)
...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
	...
	OpenMenu(function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			TriggerServerEvent('corazon_character:save', skin)
...
RegisterNetEvent('corazon:playerSpawned')
AddEventHandler('corazon:playerSpawned', function()
	Citizen.CreateThread(function()
		if FirstSpawn then
			TriggerServerCallback('corazon_character:getPlayerSkin', function(skin, ped)
...
AddEventHandler('corazon_character:getLastSkin', function(cb)
	cb(lastSkinOld)
end)

AddEventHandler('corazon_character:setLastSkin', function(skin)
	lastSkinOld = skin
end)

RegisterNetEvent('corazon_character:openMenu')
AddEventHandler('corazon_character:openMenu', function(submitCb, cancelCb)
	OpenMenu(submitCb, cancelCb, nil)
end)

RegisterNetEvent('corazon_character:openRestrictedMenu')
AddEventHandler('corazon_character:openRestrictedMenu', function(submitCb, cancelCb, restrict)
	OpenMenu(submitCb, cancelCb, restrict)
end)

RegisterNetEvent('corazon_character:openSaveableMenu')
AddEventHandler('corazon_character:openSaveableMenu', function(submitCb, cancelCb)
	ShowSkinCreator(true)
end)

RegisterNetEvent('corazon_character:openSaveableRestrictedMenu')
AddEventHandler('corazon_character:openSaveableRestrictedMenu', function(submitCb, cancelCb, restrict)
	OpenSaveableMenu(submitCb, cancelCb, restrict)
end)

RegisterNetEvent('corazon_character:requestSaveSkin')
AddEventHandler('corazon_character:requestSaveSkin', function()
	TriggerEvent('skinchanger:getSkin', function(skin)
		TriggerServerEvent('corazon_character:responseSaveSkin', skin)
	end)
end)
